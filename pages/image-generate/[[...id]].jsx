...
import ImageDetails from "@/page-components/dashboard/imageGenerate";
...
const PageImageGenerate = ({ userId }) => {
  ...
  const templateMutation = useMutation({
    ...
    onError: (error) => {
      // makeToast({
      //   type: "error",
      //   message: `${t("error.PageImageGenerate")}`
      // });
    }
  });
  useEffect(() => {
  ...
  return (
    <>
      ...
      {formData ? (
        <ImageDetails id={userId} formData={formData} />
      ) : (
...
PageImageGenerate.auth = "ONLY_LOGIN_USER";
export default PageImageGenerate;
